...
%     zC(:, i+1) = LieEulerSE3(f, action, zC(:, i), dt);
    zC(:, i+1) = NewtonItSE3(myRes, myJac, zC(:, i), dt, max_it, tol);
...
disp(potential_energy(end)-potential_energy(1)+kinetic_energy(end)-kinetic_energy(1))
